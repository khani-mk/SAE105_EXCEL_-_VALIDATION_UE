...
if __name__ == "__main__":
    ...
    fichier_de_ref = '/SAE105_EXCEL_-_VALIDATION_UE/data/coefficients/Coef.xlsx'

    dossiers_notes = []
    dossiers_notes.append('/SAE105_EXCEL_-_VALIDATION_UE/data/notes/notes_S1')
    dossiers_notes.append('/SAE105_EXCEL_-_VALIDATION_UE/data/notes/notes_S2')
    ...
    with open("/SAE105_EXCEL_-_VALIDATION_UE/html/mes_notes.html", "w", encoding="utf-8") as file:
